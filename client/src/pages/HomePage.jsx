...
export default function HomePage() {
    ...
    return (
        <div>
            ...
            <p className="py-3">Sort By: <button className="px-3 font-bold" onClick={sortByOldest}>Oldest</button><button onClick={sortByLatest} className="px-3 font-bold">Latest</button><button className="px-3 font-bold">Most Popular</button></p>
